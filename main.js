var stripe_key = "sk_test_tbEd0XduLZc0CGREMSFe6Ln400XlFTrK2W";
...
console.log("got token");
 Stripe.charges.create({
        amount: 200, // It needs to convert to cents
        currency: "usd",
        source: request.params.token,
        description: "Charge for button "
    }, function(err, charge) {
        if (!err){
        ...
        console.log("charge incomplete");
		response.error("charge incomplete")
    });
